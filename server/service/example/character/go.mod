module gitlab.com/alienspaces/go-boilerplate/server/service/character
...
require (
	...
	gitlab.com/alienspaces/go-boilerplate/server/constant v1.0.0
...
replace (
	...
	gitlab.com/alienspaces/go-boilerplate/server/service/character => ../character
)

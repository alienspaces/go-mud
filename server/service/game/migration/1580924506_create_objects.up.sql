...
CREATE TABLE "dungeon_action" (
  ...
  CONSTRAINT "dungeon_action_character_instance_id_fk" FOREIGN KEY (character_instance_id) REFERENCES character_instance(id),
  CONSTRAINT "dungeon_action_monster_instance_id_fk" FOREIGN KEY (monster_instance_id) REFERENCES monster_instance(id),

...
func (rnr *Runner) RecordToDungeonActionCharacterActionResponseData(dungeonActionRecordSet model.DungeonActionRecordSet) (*schema.DungeonActionResponseData, error) {
	...
	// Equipped object
	var equippedObjectData *schema.ObjectData
	...
	// Stashed object
	var stashedObjectData *schema.ObjectData
	...
	// Target object
	var targetObjectData *schema.ObjectData
	...
	// Target character
	var targetCharacterData *schema.CharacterData
	...
	// Target monster
	var targetMonsterData *schema.MonsterData

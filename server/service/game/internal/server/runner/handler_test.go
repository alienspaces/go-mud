...
func TestGameHandler(t *testing.T) {
	...
	type TestCase struct {
		...
		requestData    func(data *harness.Data) *schema.GameRequest
		responseCode   int
		responseData   func(data *harness.Data) *schema.GameResponse
	}
	...
	tests := []TestCase{
		...
		},
		{
			...
			requestParams: func(data *harness.Data) map[string]string {
				params := map[string]string{
					":game_id": "17c19414-2d15-4d20-8fc3-36fc10341dc8",
				}
				return params
			},
			requestData: func(data *harness.Data) *schema.GameRequest {
		...
		},
		{
			...
			requestParams: func(data *harness.Data) map[string]string {
				params := map[string]string{
					":game_id": "e3a9e0f8-ce9c-477b-8b93-cf4da03af4c9",
				}
				return params
			},
			requestData: func(data *harness.Data) *schema.GameRequest {
	...
	for _, tc := range tests {
		...
		func() {
			...
			// response data
			var resData *schema.GameResponse

...
const (
	...
	TableName string = "dungeon_location"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:  TableName,
				Attributes: tag.GetValues(record.DungeonLocation{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.DungeonLocation {
	return &record.DungeonLocation{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.DungeonLocation {
	return []*record.DungeonLocation{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.DungeonLocation, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.DungeonLocation, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.DungeonLocation) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.DungeonLocation) error {
...
func (r *Repository) CreateTestRecord(rec *record.DungeonLocation) error {

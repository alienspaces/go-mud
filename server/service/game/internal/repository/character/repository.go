...
// NewRecord -
func (r *Repository) NewRecord() *record.DungeonCharacter {
	return &record.DungeonCharacter{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.DungeonCharacter {
	return []*record.DungeonCharacter{}
}
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.DungeonCharacter, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.DungeonCharacter) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.DungeonCharacter) error {
...
func (r *Repository) CreateTestRecord(rec *record.DungeonCharacter) error {

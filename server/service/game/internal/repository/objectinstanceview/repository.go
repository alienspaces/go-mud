	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:  TableName,
				Attributes: tag.GetValues(record.ObjectInstanceView{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.ObjectInstanceView, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.ObjectInstanceView, error) {

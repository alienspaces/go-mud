...
const (
	...
	TableName string = "character_instance_view"
)
...
// NewRecord -
func (r *Repository) NewRecord() *record.CharacterInstanceView {
	return &record.CharacterInstanceView{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.CharacterInstanceView {
	return []*record.CharacterInstanceView{}
}

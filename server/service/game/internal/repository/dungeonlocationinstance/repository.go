package dungeonlocationinstance
...
const (
	...
	TableName string = "dungeon_location_instance"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:  TableName,
				Attributes: tag.GetValues(record.DungeonLocationInstance{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.DungeonLocationInstance {
	return &record.DungeonLocationInstance{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.DungeonLocationInstance {
	return []*record.DungeonLocationInstance{}
}

// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.DungeonLocationInstance, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.DungeonLocationInstance, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.DungeonLocationInstance) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.DungeonLocationInstance) error {
...
func (r *Repository) CreateTestRecord(rec *record.DungeonLocationInstance) error {

...
// validateCharacterObjectRec - validates creating and updating a character object record
...
// validateDeleteCharacterObjectRec - validates it is okay to delete a character object record

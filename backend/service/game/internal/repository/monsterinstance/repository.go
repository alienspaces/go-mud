	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.MonsterInstance{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.MonsterInstance{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.MonsterInstance, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.MonsterInstance, error) {

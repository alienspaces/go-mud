...
const (
	...
	TableName string = "location_monster"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.LocationMonster{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.LocationMonster{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.LocationMonster {
	return &record.LocationMonster{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.LocationMonster {
	return []*record.LocationMonster{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.LocationMonster, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.LocationMonster, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.LocationMonster) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.LocationMonster) error {

	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:  TableName,
				Attributes: tag.GetValues(record.LocationMonster{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, forUpdate bool) (*record.LocationMonster, error) {
	rec := r.NewRecord()
...
func (r *Repository) GetMany(
	...
	forUpdate bool) ([]*record.LocationMonster, error) {

...
const (
	...
	TableName string = "character_instance"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.CharacterInstance{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.CharacterInstance{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.CharacterInstance, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.CharacterInstance, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.CharacterInstance) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.CharacterInstance) error {

	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.Location{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.Location{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.Location {
	return &record.Location{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Location {
	return []*record.Location{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.Location, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.Location, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Location) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Location) error {

	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.Turn{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.Turn{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.Turn, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.Turn, error) {

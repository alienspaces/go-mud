...
const (
	...
	TableName string = "location_object"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.LocationObject{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.LocationObject{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.LocationObject {
	return &record.LocationObject{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.LocationObject {
	return []*record.LocationObject{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.LocationObject, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.LocationObject, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.LocationObject) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.LocationObject) error {

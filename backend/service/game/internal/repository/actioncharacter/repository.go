...
const (
	...
	TableName string = "action_character"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.ActionCharacter{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.ActionCharacter{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.ActionCharacter {
	return &record.ActionCharacter{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.ActionCharacter {
	return []*record.ActionCharacter{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.ActionCharacter, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.ActionCharacter, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.ActionCharacter) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.ActionCharacter) error {

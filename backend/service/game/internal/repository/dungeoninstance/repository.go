	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.DungeonInstance{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.DungeonInstance{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.DungeonInstance, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.DungeonInstance, error) {

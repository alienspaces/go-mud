	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.Object{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.Object{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.Object {
	return &record.Object{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.Object {
	return []*record.Object{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.Object, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.Object, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.Object) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.Object) error {

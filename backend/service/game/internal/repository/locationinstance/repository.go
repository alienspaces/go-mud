...
const (
	...
	TableName string = "location_instance"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.LocationInstance{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.LocationInstance{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.LocationInstance {
	return &record.LocationInstance{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.LocationInstance {
	return []*record.LocationInstance{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.LocationInstance, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.LocationInstance, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.LocationInstance) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.LocationInstance) error {

...
const (
	...
	TableName string = "monster_object"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.MonsterObject{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.MonsterObject{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.MonsterObject {
	return &record.MonsterObject{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.MonsterObject {
	return []*record.MonsterObject{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.MonsterObject, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.MonsterObject, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.MonsterObject) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.MonsterObject) error {

	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.LocationInstanceView{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.LocationInstanceView{}, "db"),
			},
		},
	}
...
// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.LocationInstanceView, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.LocationInstanceView, error) {

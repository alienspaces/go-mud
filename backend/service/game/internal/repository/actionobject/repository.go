...
const (
	...
	TableName string = "action_object"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.ActionObject{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.ActionObject{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.ActionObject {
	return &record.ActionObject{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.ActionObject {
	return []*record.ActionObject{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.ActionObject, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.ActionObject, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.ActionObject) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.ActionObject) error {

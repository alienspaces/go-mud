...
const (
	...
	TableName string = "action_monster_object"
)
	...
	r := &Repository{
		repository.Repository{
			...
			Config: repository.Config{
				TableName:   TableName,
				Attributes:  tag.GetFieldTagValues(record.ActionMonsterObject{}, "db"),
				ArrayFields: tag.GetArrayFieldTagValues(record.ActionMonsterObject{}, "db"),
			},
		},
	}
...
// NewRecord -
func (r *Repository) NewRecord() *record.ActionMonsterObject {
	return &record.ActionMonsterObject{}
}

// NewRecordArray -
func (r *Repository) NewRecordArray() []*record.ActionMonsterObject {
	return []*record.ActionMonsterObject{}
}

// GetOne -
func (r *Repository) GetOne(id string, lock *coresql.Lock) (*record.ActionMonsterObject, error) {
	rec := r.NewRecord()
...
// GetMany -
func (r *Repository) GetMany(opts *coresql.Options) ([]*record.ActionMonsterObject, error) {
...
// CreateOne -
func (r *Repository) CreateOne(rec *record.ActionMonsterObject) error {
...
// UpdateOne -
func (r *Repository) UpdateOne(rec *record.ActionMonsterObject) error {
